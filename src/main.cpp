...
int main(int argc, char *argv[]) {
    ...
    if (  myappTranslator.load(QLocale(), QLatin1String("UnRiddle"), QLatin1String("_"), QLatin1String(":/res/i18n")) ){
    ...
    qmlRegisterSingletonInstance("io.github.zanyxdev.unriddle.hal", 1, 0,"HAL", m_hal.get());
    engine.load(url);
